...
def OptHis2HTML(OptName, Alg, DesOptDir):
    ...
    fAll = OptHist.read([0, -1], ["obj"])[0]["obj"]         # Alle Zielfkt-werte auslesen
    xAll = OptHist.read([0, -1], ["x"])[0]["x"]             # Alle Designvariablen auslesen
    gAll = OptHist.read([0, -1], ["con"])[0]["con"]         # Alle Nebenbedingungen auslesen
    if Alg == "NLPQLP":
