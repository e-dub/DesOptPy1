...
#            OptSolData = pickle.load(file_OptSolData)
    ...
    if diagrams == 1:
        ...
        if operatingSystem=='Windows':
            ...
            subprocess.call("inkscape.exe -D -z --file="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_fgMaxIterNorm.pdf --export-pdf="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_fgMaxIterNorm.pdf --export-latex", shell=True)
            subprocess.call("inkscape.exe -D -z --file="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_fgMaxIter.pdf --export-pdf="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_fgMaxIter.pdf --export-latex", shell=True)
            subprocess.call("inkscape.exe -D -z --file="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_gIter.pdf --export-pdf="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_gIter.pdf --export-latex", shell=True)
            subprocess.call("inkscape.exe -D -z --file="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_gBar.pdf --export-pdf="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_gBar.pdf --export-latex", shell=True)
            subprocess.call("inkscape.exe -D -z --file="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_fBar.pdf --export-pdf="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_fBar.pdf --export-latex", shell=True)

            progressbar(68,82)

            subprocess.call("inkscape.exe -D -z --file="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_fGradIter.pdf --export-pdf="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_fGradIter.pdf --export-latex", shell=True)
            subprocess.call("inkscape.exe -D -z --file="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_xIter.pdf --export-pdf="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_xIter.pdf --export-latex", shell=True)
            subprocess.call("inkscape.exe -D -z --file="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_xIterNorm.pdf --export-pdf="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_xIterNorm.pdf --export-latex", shell=True)
            subprocess.call("inkscape.exe -D -z --file="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_xBar.pdf --export-pdf="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_xBar.pdf --export-latex", shell=True)
            subprocess.call("inkscape.exe -D -z --file="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_xBarNorm.pdf --export-pdf="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_xBarNorm.pdf --export-latex", shell=True)
            subprocess.call("inkscape.exe -D -z --file="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_gGradOpt.pdf --export-pdf="+"../DesOpt/Results/"+optname+"/ResultReport/"+OptName+"_gGradOpt.pdf --export-latex", shell=True)
